...
public class AdapterRSAPackageDetails extends  RecyclerView.Adapter<AdapterRSAPackageDetails.RecyclerViewHolder>{
    ArrayList<PojoPackageList> pmpserviceslist;

    Context context;

    public AdapterRSAPackageDetails(ArrayList<PojoPackageList> pmpserviceslist, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        if(recyclerdata.getStatus_id()==null){
