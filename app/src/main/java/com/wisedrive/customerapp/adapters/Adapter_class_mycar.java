...
public class Adapter_class_mycar extends RecyclerView.Adapter<Adapter_class_mycar.MyViewHolder> {
    Context context;
    private View view;
    ...
    @Override
    public Adapter_class_mycar.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_class_mycar,parent,false);
       // view.getLayoutParams().width = (int) (getScreenWidth()/1.2);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_class_mycar.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
